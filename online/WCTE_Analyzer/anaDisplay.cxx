...
public:
  ...
  void AddAllCanvases(){
    ...
    //AddSingleCanvas(new TFancyHistogramCanvas(anaManager->GetTDT730Waveform(),"Waveforms"),"DT730");
    //AddSingleCanvas(new TFancyHistogramCanvas(anaManager->GetTDT730Amplitude(),"Amplitudes"),"DT730");
    //AddSingleCanvas(new TFancyHistogramCanvas(anaManager->GetTDT730Time(),"Times"),"DT730");
    ...
    SetDisplayName("WCTE test beam online monitor");
